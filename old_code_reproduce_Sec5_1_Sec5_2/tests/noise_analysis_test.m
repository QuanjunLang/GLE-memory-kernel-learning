...
plot(log10(noise_seq), log10(error_upper_bound_seq), '-', 'Color', [0    0.4470    0.7410],'DisplayName', ['Theoretical' newline 'upper bound'], 'LineWidth', 4);
plot(log10(noise_seq), log10(gamma_regression_com_error_seq), '-', 'Color', [ 0.8500    0.3250    0.0980], 'DisplayName', '$\theta$', 'LineWidth', 6);
plot(log10(noise_seq), log10(gamma_regression_ill_error_seq), '-.', 'Color', [0.4660    0.6740    0.1880], 'DisplayName', '$\theta_1$', 'LineWidth', 4);
plot(log10(noise_seq), log10(gamma_regression_dev_error_seq), '--', 'Color', [0.4940    0.1840    0.5560], 'DisplayName', '$\theta_2$', 'LineWidth', 4);
plot(log10(noise_seq), log10(gamma_prony_error_seq), ':',  'Color',  [0.9290    0.6940    0.1250], 'DisplayName', '$\theta_L$', 'LineWidth', 4, 'MarkerSize',5);
...
plot(log10(noise_seq), log10(1./m_h_eps_seq), '-', 'Color', blue, 'DisplayName', '$m_\omega^{h_\varepsilon}$', 'LineWidth', 4);
...
plot(log10(noise_seq), log10(sqrt(h_error_seq_square)), '-', 'Color', red, 'DisplayName', '$\|h - h_\varepsilon\|_{L^2(\rho)}$', 'LineWidth', 4);
plot(log10(noise_seq), log10(sqrt(g_error_seq_square)), '-.', 'Color', red, 'DisplayName', '$\|g - g_\varepsilon\|_{H^1_{\alpha}(\rho)}$', 'LineWidth', 4);
