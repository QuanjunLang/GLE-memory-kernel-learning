...
%% noise sequence
Len = 9;
noise_seq = 10.^linspace(-1.5, 0.5, Len);
...
for i = 1:length(noise_seq)
    ...
    tau_grid_real = 10.^linspace(-10, 10, 100000);
...
% 
% plot(log10(noise_seq), log10(gamma_regression_com_error_seq), '-', 'Color', [ 0.8500    0.3250    0.0980], 'DisplayName', '$\|\theta - \gamma\|_{L^2(\rho)}$', 'LineWidth', 6);
% plot(log10(noise_seq), log10(gamma_prony_error_seq), ':',  'Color',  [0.9290    0.6940    0.1250], 'DisplayName', '$\|\theta_L - \gamma\|_{L^2(\rho)}$', 'LineWidth', 4, 'MarkerSize',5);
% plot(log10(noise_seq), log10(gamma_regression_ill_error_seq), '-.', 'Color', [0.4660    0.6740    0.1880], 'DisplayName', '$\|\theta_1 - \gamma\|_{L^2(\rho)}$', 'LineWidth', 4);
% plot(log10(noise_seq), log10(gamma_regression_dev_error_seq), '--', 'Color', [0.4940    0.1840    0.5560], 'DisplayName', '$\|\theta_2 - \gamma\|_{L^2(\rho)}$', 'LineWidth', 4);
plot(log10(noise_seq.^2), log10(error_upper_bound_seq), '-', 'Color', [0    0.4470    0.7410],'DisplayName', ['Theoretical' newline 'upper bound'], 'LineWidth', 4);
plot(log10(noise_seq.^2), log10(gamma_regression_com_error_seq), '-', 'Color', [ 0.8500    0.3250    0.0980], 'DisplayName', '$\theta$', 'LineWidth', 6);
plot(log10(noise_seq.^2), log10(gamma_regression_ill_error_seq), '-.', 'Color', [0.4660    0.6740    0.1880], 'DisplayName', '$\theta_1$', 'LineWidth', 4);
plot(log10(noise_seq.^2), log10(gamma_regression_dev_error_seq), '--', 'Color', [0.4940    0.1840    0.5560], 'DisplayName', '$\theta_2$', 'LineWidth', 4);
plot(log10(noise_seq.^2), log10(gamma_prony_error_seq), ':',  'Color',  [0.9290    0.6940    0.1250], 'DisplayName', '$\theta_L$', 'LineWidth', 4, 'MarkerSize',5);

xlabel('$log_{10}(\sigma_{obs}^2)$','Interpreter','latex')
ylabel('$log_{10} L^2(\rho)$ error','Interpreter','latex')
xlim([min(log10(noise_seq.^2)), max(log10(noise_seq.^2))])
title('Change of the $L^2(\rho)$ errors with $\sigma_{obs}^2$','Interpreter','latex')
...
% nexttile;grid on;hold on;
% plot(log10(noise_seq), log10(gamma_norm_seq), '-', 'Color', blue, 'DisplayName', '$\|\gamma\|_{L^2(\rho)}$', 'LineWidth', 4);
% plot(log10(noise_seq), log10(gamma_regression_com_error_seq./gamma_norm_seq), '-', 'Color', red, 'DisplayName', '$\theta$', 'LineWidth', 6);
% plot(log10(noise_seq), log10(gamma_regression_ill_error_seq./gamma_norm_seq), '-.', 'Color', [0.4660    0.6740    0.1880], 'DisplayName', '$\theta_1$', 'LineWidth', 4);
% plot(log10(noise_seq), log10(gamma_regression_dev_error_seq./gamma_norm_seq), '--', 'Color', [0.4940    0.1840    0.5560], 'DisplayName', '$\theta_2$', 'LineWidth', 4);
% plot(log10(noise_seq), log10(gamma_prony_error_seq./gamma_norm_seq), ':',  'Color',  [0.9290    0.6940    0.1250], 'DisplayName', '$\theta_L$', 'LineWidth', 4, 'MarkerSize',5);
% 
% xlabel('$log_{10}(\omega)$','Interpreter','latex')
% ylabel('$log_{10}$ relative $L^2(\rho)$ error','Interpreter','latex')
% xlim([min(log10(noise_seq)), max(log10(noise_seq))])
...
plot(log10(noise_seq.^2), log10(1./m_h_eps_seq), '-', 'Color', blue, 'DisplayName', '$1/m_\omega^{h_\varepsilon}$', 'LineWidth', 4);
% plot(log10(noise_seq), log10(1./m_2_seq), '-', 'Color',  purple, 'DisplayName', '$m_2$', 'LineWidth', 4);
% plot(log10(noise_seq), log10(M_gamma_seq), '-.', 'Color',  'black', 'DisplayName', '$M_\omega^\gamma$', 'LineWidth', 4);
plot(log10(noise_seq.^2), log10(sqrt(h_error_seq_square)), '-', 'Color', red, 'DisplayName', '$\|h - h_\varepsilon\|_{L^2(\rho)}$', 'LineWidth', 4);
plot(log10(noise_seq.^2), log10(sqrt(g_error_seq_square)), '-.', 'Color', red, 'DisplayName', '$\|g - g_\varepsilon\|_{H^1_{\alpha}(\rho)}$', 'LineWidth', 4);
...
set(gcf, 'position', [800, 800, 800, 400])
...
% a = 1;
print(fig, [fig_dir, 'conv_noise.pdf'], '-dpdf', '-r0')
...
% % loglog(noise_seq, upper_bound_errror, 'LineWidth', 4);
